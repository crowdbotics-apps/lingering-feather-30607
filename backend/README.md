...
## Project Structure
    ...
    ├── lingering_feather_30607  # Django project configurations
...
1. Clone this repo and `cd lingering_feather_30607`
...
2. Clone this repo and `cd lingering_feather_30607`
